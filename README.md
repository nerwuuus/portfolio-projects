...
## General information
PowerQuery pulls data from several dozen smaller historical reports (each covering one month), transform it, and generates a consolidated report spanning from April 2022 to the present day.
